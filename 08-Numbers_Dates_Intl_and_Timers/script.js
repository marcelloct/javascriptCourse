...
// all numbers are presented internally as floating point number
console.log(23 === 23.0);

// numbers allways stored in a binary format
// Base 10 - 0 to 9
// binary base 2 - 0 1
console.log(0.1 + 0.2);
...
// Parsing
console.log(Number.parseInt("30px")); // Need to star with a number
console.log(Number.parseInt("e23"));
console.log(Number.parseInt("30px", 10)); // second argument: regex, indicates the use of base 10 for avoid some bugs
...
const future2 = new Date(2037, 10, 19);
console.log(+future2);

const calcDaysPassed = (date1, date2) =>
  Math.abs(date2 - date1) / (1000 * 60 * 60 * 24);

const days1 = calcDaysPassed(new Date(2037, 10, 19), new Date(2037, 3, 24));
console.log(days1);
...
// Examples above in Bankist Application
